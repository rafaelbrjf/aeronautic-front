...
var CollectionContext = React17.createContext(null);
function Collection(_ref) {
  var children = _ref.children, onBatchResize = _ref.onBatchResize;
  var resizeIdRef = React17.useRef(0);
  var resizeInfosRef = React17.useRef([]);
  var onCollectionResize = React17.useContext(CollectionContext);
  var onResize2 = React17.useCallback(function(size, element, data) {
  ...
  return React17.createElement(CollectionContext.Provider, {
    value: onResize2
  }, children);
}
...
function SingleObserver(props, ref) {
  ...
  var mergedRef = React18.useMemo(function() {
...
function ExpandedRow(props) {
  ...
  if (isEmpty ? horizonScroll : fixColumn) {
    contentNode = React21.createElement("div", {
      style: {
  ...
  return React21.createElement(Component2, {
    className,
    style: {
      display: expanded ? null : "none"
    }
  }, React21.createElement(Cell_default, {
...
function BodyRow(props) {
  ...
  var _React$useState = React23.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), expandRended = _React$useState2[0], setExpandRended = _React$useState2[1];
  if (true) {
    useRenderTimes_default(props);
  }
...
function useWidthColumns(columns, scrollWidth) {
  var filledColumns = React31.useMemo(function() {
...
function useColumns(_ref2, transformColumns) {
  ...
  var filledColumns = useWidthColumns(flattenColumns, scrollWidth);
...
function Table(tableProps) {
  ...
  }), useInternalHooks ? transformColumns : null), _useColumns2 = _slicedToArray(_useColumns, 2), columns = _useColumns2[0], flattenColumns = _useColumns2[1];
  ...
  if (fixHeader || isSticky) {
    ...
    }), renderFixedFooterTable), isSticky && React39.createElement(stickyScrollBar_default, {
      ref: stickyRef,
      offsetScroll,
      scrollBodyRef,
      onScroll,
...
var ScrollBar = React41.forwardRef(function(props, ref) {
  var _classNames;
  var prefixCls = props.prefixCls, rtl = props.rtl, scrollOffset = props.scrollOffset, scrollRange = props.scrollRange, onStartMove = props.onStartMove, onStopMove = props.onStopMove, onScroll = props.onScroll, horizontal = props.horizontal, spinSize = props.spinSize, containerSize = props.containerSize;
...
// node_modules/rc-virtual-list/es/List.js
var _excluded6 = ["prefixCls", "className", "height", "itemHeight", "fullHeight", "style", "data", "children", "itemKey", "virtual", "direction", "scrollWidth", "component", "onScroll", "onVirtualScroll", "onVisibleChange", "innerProps", "extraRender"];
var EMPTY_DATA2 = [];
var ScrollStyle = {
  overflowY: "auto",
  overflowAnchor: "none"
...
function VirtualCell(props) {
  var rowInfo = props.rowInfo, column = props.column, colIndex = props.colIndex, indent = props.indent, index2 = props.index, record = props.record, style = props.style, className = props.className, inverse = props.inverse, getHeight = props.getHeight;
...
var BodyLine = React50.forwardRef(function(props, ref) {
  ...
  var record = data.record, indent = data.indent;
  var _useContext = useContext2(TableContext_default, ["prefixCls", "flattenColumns", "fixColumn", "componentWidth"]), flattenColumns = _useContext.flattenColumns, prefixCls = _useContext.prefixCls, fixColumn = _useContext.fixColumn, componentWidth = _useContext.componentWidth;
  var _useContext2 = useContext2(StaticContext, ["scrollX"]), scrollX = _useContext2.scrollX;
  var rowInfo = useRowInfo(record, rowKey, index2, indent);
...
var Grid = React51.forwardRef(function(props, ref) {
  ...
  var _useContext = useContext2(TableContext_default, ["flattenColumns", "onColumnResize", "getRowKey", "prefixCls", "expandedKeys", "childrenColumnName", "emptyNode"]), flattenColumns = _useContext.flattenColumns, onColumnResize = _useContext.onColumnResize, getRowKey = _useContext.getRowKey, expandedKeys = _useContext.expandedKeys, prefixCls = _useContext.prefixCls, childrenColumnName = _useContext.childrenColumnName, emptyNode = _useContext.emptyNode;
  var _useContext2 = useContext2(StaticContext), scrollY = _useContext2.scrollY, scrollX = _useContext2.scrollX, listItemHeight = _useContext2.listItemHeight;
...
function VirtualTable(props) {
  var columns = props.columns, scroll = props.scroll, _props$prefixCls = props.prefixCls, prefixCls = _props$prefixCls === void 0 ? DEFAULT_PREFIX : _props$prefixCls, className = props.className, listItemHeight = props.listItemHeight;
  var _ref = scroll || {}, scrollX = _ref.x, scrollY = _ref.y;
  if (typeof scrollX !== "number") {
    scrollX = ((columns || []).length + 1) * PRESET_COLUMN_WIDTH;
    if (true) {
      warning_default(false, "`scroll.x` in virtual table must be number.");
    }
  }
